            ...
            <div className='Form_input'>
                ...
                }
                {
                    ...
                    <form onSubmit={this.handleSubmit}>
                        <span className='fh_ad_label'><FormattedMessage id="fd_partner_become_area"/></span><span className='ft_required_mark'>*</span>
                        <br/>
                        <select
                        ...
                        <span className='fh_ad_label'><FormattedMessage id="fd_partner_become_name"/></span><span className='ft_required_mark'>*</span><br/>
                        ...
                        <span className='fh_ad_label'><FormattedMessage id="fd_partner_become_phone"/></span><span className='ft_required_mark'>*</span><br/>
                        ...
                        <span className='fh_ad_label'><FormattedMessage id="fd_partner_become_email"/></span><span className='ft_required_mark'>*</span><br/>
                        ...
                        <span className='fh_ad_label'><FormattedMessage id="fd_partner_become_busname"/></span><span className='ft_required_mark'>*</span><br/>
                        ...
                        <span className='fh_ad_label'><FormattedMessage id="fd_partner_become_busadr"/></span><span className='ft_required_mark'>*</span><br/>
                        ...
                        <span className='fh_ad_label'><FormattedMessage id="fd_partner_become_buscat"/></span><span className='ft_required_mark'>*</span><br/>
                        ...
                        <div style={{padding: '0 0 35px 0'}} />
                            ...
                            <div>
                                <span className='fh_ad_label'><FormattedMessage id="fd_partner_become_Desc"/></span>
                                <br />
                            ...
                            <div className='ft_ad_verificode'>
                                <span className='fh_ad_label'><FormattedMessage id="fd_partner_become_inputcode"/></span><span className='ft_required_mark'>*</span><br/>
